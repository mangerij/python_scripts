...
[Kernels]
  ...
  [./FE_E_int]
     ...
     variable = potential_int
     block = '1'
     permittivity = 1.16 #approximately 2\epsilon_0, just for testing purposes
  [../]
...
[BCs]
  [./Periodic]
    [./potential_int_pbc_vac]
      variable = potential_int
      primary = '3'
      secondary = '4'
      translation = '0 0 -30'
    [../]
    [./potential_int_pbc_FE]
      variable = potential_int
      primary = '7'
      secondary = '8'
      translation = '0 0 30'
...
[Outputs]
  ...
  [./out]
    type = Exodus
    file_base = out_PZT_nanowire_free_r10_h30
    interval = 1
  [../]
[]
